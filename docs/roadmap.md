...
Recorded as `work.discovered` events on `[0002]` at gating (doctrine §8: a finding that stays in the
transcript was never found), routed here per the §6 routing table. None block S2's merge gate.
