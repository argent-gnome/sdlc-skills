...
## Active
- **0001-house-v2-s2-skills-rewrite** — house v2 S2 — skills rewrite · state: building · 0/17
## In-flight
- none
## Slated
- none
...
- **`0001-house-v2-s2-skills-rewrite`** — house v2 S2 — **state `building` (2026-07-28)** — Unit 1 (CLI enablers, U1-T1…T10 + closeout) dispatched to a background builder on branch `slice/0001-house-v2-s2-skills-rewrite`. Appetite 3 sessions.
- **Next action:** intake the Unit 1 builder report → then dispatch Unit 2 (doctrine v2 + the three `house2-*` skills). Plan @ `docs/slices/0001-house-v2-s2-skills-rewrite/plan.md`, 3 units. Merge-gate runs on the completed slice diff after Unit 3.
